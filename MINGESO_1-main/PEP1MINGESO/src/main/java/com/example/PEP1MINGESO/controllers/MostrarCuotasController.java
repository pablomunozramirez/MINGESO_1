...
public class MostrarCuotasController {
    ...
    public String obtenerRutParaMostrar(@RequestParam String rut, Model model, RedirectAttributes redirectAttributes){
        try {
            ArrayList<CuotaEntity> cuotas = cuotaService.obternerCuotaPorRut(rut);
    ...
    @GetMapping("/cuota")
    public String mostrarCuotas (@ModelAttribute("rut") String rut, @ModelAttribute("cuotas") ArrayList<CuotaEntity> cuotas){
    ...
    @GetMapping("/cuota2")
    public String mostrarCuotas2 (@ModelAttribute("rut") String rut, @ModelAttribute("cuotas") ArrayList<CuotaEntity> cuotas){
