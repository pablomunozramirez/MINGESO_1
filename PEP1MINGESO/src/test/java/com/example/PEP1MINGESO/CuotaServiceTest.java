...
public class CuotaServiceTest {
    ...
    public void testGenerarCuota() {
        ...
        List<CuotaEntity> cuotas = cuotaService.generarCuota("20627890-0", "10");
    ...
    public void testGenerarCuota2() {
        ...
        List<CuotaEntity> cuotas = cuotaService.generarCuota("20627890-0", "1");
    ...
    public void obternerCuotaPorRutTest(){
        ...
        List<CuotaEntity> cuotas2 = cuotaService.obternerCuotaPorRut("20627890-0");
