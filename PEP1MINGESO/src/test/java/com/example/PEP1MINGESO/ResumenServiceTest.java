...
public class ResumenServiceTest {
    ...
    public void generarResumenEstudianteTest(){
        ...
        List<PruebasEntity> pruebas = new ArrayList<>();
        pruebas.add(prueba);
        pruebas.add(prueba1);
    ...
    public void resumenArancelTest(){
        ...
        List<ResumenEntity> arancelTodos = resumenService.resumenArancel();
    ...
    public void calcularInteresCuotasTest(){
        ...
        List<CuotaEntity> cuotasResultado = resumenService.calcularInteresCuotas("20627890-0");
    ...
    public void calcularDescuentosCuotasTest(){
        ...
        when(cuotaRepository.findByRutCuota(anyString())).thenReturn(cuotas);
        List<CuotaEntity> cuotasResultado = resumenService.calcularDescuentosCuotas("20627890-0");
        for (CuotaEntity cuota : cuotasResultado) {
        ...
        public void aplicarDescuento(){
            ...
            List<CuotaEntity> cuotaR = resumenService.aplicarDescuentos();
